...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentStatusReport) DeepCopyInto(out *DeploymentStatusReport) {
	*out = *in
	in.Start.DeepCopyInto(&out.Start)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentStatusReport.
func (in *DeploymentStatusReport) DeepCopy() *DeploymentStatusReport {
	if in == nil {
		return nil
	}
	out := new(DeploymentStatusReport)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PropagationStatus) DeepCopyInto(out *PropagationStatus) {
	*out = *in
	if in.DeploymentStatusHistory != nil {
		in, out := &in.DeploymentStatusHistory, &out.DeploymentStatusHistory
		*out = make([]DeploymentStatusReport, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
