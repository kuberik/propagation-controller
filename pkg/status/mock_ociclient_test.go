...
// Source: kuberik.io/propagation-controller/pkg/status (interfaces: OCIClient)
//
// Generated by this command:
//
//	mockgen -destination mock_ociclient_test.go -package status kuberik.io/propagation-controller/pkg/status OCIClient
//
